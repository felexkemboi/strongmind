...
<div class="tocify-wrapper">
    ...
    <ul id="toc">
            ...
            <li>Last updated: August 3 2021</li>
        </ul>
</div>
...
<pre><code class="language-bash">curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -F "profile_pic=@C:\Users\John Onyango\AppData\Local\Temp\php2FE8.tmp" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/auth/profile/set-photo"
);
...
<pre><code class="language-bash">curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"country_id":14,"name":"corrupti","active":1}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/office/update/1"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "http://localhost:8000/api/teams/all?role=15&amp;sort=magnam" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
...
<pre><code class="language-bash">curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"name":"error","email":"voluptatem","phone_number":"vel","office_id":1,"role_id":1,"timezone_id":2,"gender":"male","region":"East Africa","city":"Nairobi","languages":["est","velit"]}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/teams/update/1"
);
...
<pre><code class="language-bash">curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"email":"quibusdam","role_id":11,"office_id":12}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/teams/invite"
);
