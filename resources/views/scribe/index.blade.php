...
<pre><code class="language-yaml">localhost:8000</code></pre><h1>Authenticating requests</h1>
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/permission/all" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/permission/all"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/role/all" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/role/all"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/role/view/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/role/view/1"
);
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/role/create" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"name":"voluptas","role_code":"iusto","description":"rerum","access_permissions":[8,15]}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/role/create"
);
...
<pre><code class="language-bash">curl -X PUT \
    "localhost:8000/api/role/update/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"name":"omnis","role_code":"et","description":"ipsum","access_permissions":[1,2]}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/role/update/1"
);
...
<pre><code class="language-bash">curl -X DELETE \
    "localhost:8000/api/role/delete/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
...
<pre><code class="language-bash">curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"email":"deleniti","password":"quaerat"}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/auth/login"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/auth/profile" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
...
<pre><code class="language-bash">curl -X PUT \
    "localhost:8000/api/auth/profile/update" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"name":"et","email":"vel","phone_number":"qui","timezone_id":2,"gender":"male","region":"East Africa","city":"Nairobi","languages":["placeat","nostrum"]}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/auth/profile/update"
);
...
<pre><code class="language-bash">curl -X PUT \
    "localhost:8000/api/auth/change-password" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"current_password":"nobis","new_password":"dolor"}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/auth/change-password"
);
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/auth/profile/set-photo" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: multipart/form-data" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -F "profile_pic=@C:\Users\user\AppData\Local\Temp\php6BEC.tmp" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/auth/profile/set-photo"
);
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'profile_pic',
                'contents' =&gt; fopen('C:\Users\user\AppData\Local\Temp\php6BEC.tmp', 'r')
            ],
        ],
    ]
);
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/auth/passwords/reset-link" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"email":"pariatur"}'
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/auth/passwords/reset" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"token":"exercitationem","email":"aspernatur","password":"et"}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/auth/passwords/reset"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/status/all" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/status/all"
);
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/status/create" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X PUT \
    "localhost:8000/api/status/update/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X DELETE \
    "localhost:8000/api/status/delete/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/channels/all" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/channels/all"
);
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/channels/create" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X PUT \
    "localhost:8000/api/channels/update/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X DELETE \
    "localhost:8000/api/channels/delete/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/group-types/all" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/group-types/all"
);
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/group-types/create" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X PUT \
    "localhost:8000/api/group-types/update/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X DELETE \
    "localhost:8000/api/group-types/delete/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/program-types/all" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/program-types/all"
);
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/program-types/create" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X PUT \
    "localhost:8000/api/program-types/update/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X DELETE \
    "localhost:8000/api/program-types/delete/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/country/all" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/country/all"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/country/active" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/country/active"
);
...
<pre><code class="language-bash">curl -X PUT \
    "localhost:8000/api/country/update" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X PATCH \
    "localhost:8000/api/country/activate" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X PATCH \
    "localhost:8000/api/country/deactivate" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/timezone/all" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/timezone/all"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/timezone/active" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/timezone/active"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/teams/all?role=1&amp;sort=qui" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/teams/all"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "localhost:8000/api/teams/show/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/teams/show/1"
);
...
<pre><code class="language-bash">curl -X PUT \
    "localhost:8000/api/teams/update/1" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"name":"voluptatem","email":"corrupti","phone_number":"minima","office_id":1,"role_id":1,"timezone_id":2,"gender":"male","region":"East Africa","city":"Nairobi","languages":["vel","sint"]}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/teams/update/1"
);
...
<pre><code class="language-bash">curl -X DELETE \
    "localhost:8000/api/teams/1/delete" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/teams/invite" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"email":"est","role_id":13,"office_id":10}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/teams/invite"
);
...
<pre><code class="language-bash">curl -X POST \
    "localhost:8000/api/teams/set-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"password":"perferendis","invite":"enim"}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "localhost:8000/api/teams/set-password"
);
