...
<pre><code class="language-bash">curl -X POST \
    ...
    -d '{"name":"quis","role_code":"reprehenderit","description":"eius","access_permissions":[17,19]}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/role/create"
);
...
<pre><code class="language-bash">curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"name":"quasi","role_code":"debitis","description":"quo","access_permissions":[4,13]}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/role/update/1"
);
...
<pre><code class="language-bash">curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"name":"reiciendis","email":"ea","phone_number":"consectetur","timezone_id":2,"gender":"male","region":"East Africa","city":"Nairobi","languages":["numquam","atque"]}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/auth/profile/update"
);
...
<pre><code class="language-bash">curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"current_password":"et","new_password":"repellat"}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/auth/change-password"
);
...
<pre><code class="language-bash">curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -F "profile_pic=@C:\Users\John Onyango\AppData\Local\Temp\phpF716.tmp" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/auth/profile/set-photo"
);
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'profile_pic',
                'contents' =&gt; fopen('C:\Users\John Onyango\AppData\Local\Temp\phpF716.tmp', 'r')
            ],
        ],
    ]
);
...
<pre><code class="language-bash">curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"country_id":4,"name":"dolore","active":1}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/office/update/1"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "http://localhost:8000/api/teams/all?role=17&amp;sort=autem" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *"</code></pre>
...
<pre><code class="language-bash">curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"name":"voluptatibus","email":"unde","phone_number":"architecto","office_id":1,"role_id":1,"timezone_id":2,"gender":"male","region":"East Africa","city":"Nairobi","languages":["aut","iure"]}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/teams/update/1"
);
...
<pre><code class="language-bash">curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"email":"maxime","role_id":19,"office_id":16}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/teams/invite"
);
...
<pre><code class="language-bash">curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Access-Control-Allow-Origin: *" \
    -d '{"password":"magnam","invite":"recusandae"}'
</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/teams/set-password"
);
